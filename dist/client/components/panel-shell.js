...
export function PanelShellBase({ children, navGroups, branding, isFullBleedRoute, renderItemBadge, fullBleedHeaderExtra, enforcePagePermission = true, }) {
    ...
    if (fullBleed) {
        return (_jsxs("div", { className: "flex h-full min-h-full flex-1 flex-col bg-background", children: [renderDrawer(true), _jsx("header", { className: "sticky top-0 z-30 shrink-0 border-b border-border bg-background/95 backdrop-blur", children: _jsxs("div", { className: "flex h-16 items-center gap-3 px-4 md:px-6", children: [_jsxs("button", { type: "button", onClick: () => setMobileOpen(true), className: cn(buttonVariants({ variant: 'outline', size: 'sm' })), "aria-label": "Abrir menu", children: [_jsx(Menu, { className: "mr-1 h-4 w-4" }), " Menu"] }), _jsxs(Link, { href: "/painel", className: "inline-flex items-center gap-3", children: [_jsx("span", { className: "inline-flex h-9 w-9 items-center justify-center rounded-2xl bg-primary/10 text-sm font-semibold text-primary", "aria-hidden": "true", children: branding.shortLabel }), _jsx("span", { className: "hidden text-sm font-semibold tracking-[0.2em] text-foreground uppercase sm:inline", children: branding.fullLabel })] }), _jsx("div", { id: "wz-header-slot", className: "ml-auto flex min-w-0 items-center gap-2", children: fullBleedHeaderExtra })] }) }), _jsx("div", { className: "min-h-0 flex-1 overflow-y-auto", children: children })] }));
    }
