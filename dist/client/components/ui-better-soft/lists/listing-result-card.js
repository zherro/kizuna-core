...
function RatingChip({ rating, reviewCount = 0, className, }) {
    const hasRating = rating != null && reviewCount > 0;
    return (_jsxs("span", { className: cn('inline-flex items-center gap-1 text-[11px] font-semibold', className), children: [_jsx(Star, { className: cn('h-3 w-3', hasRating ? 'fill-current text-amber-500' : 'text-muted-foreground') }), hasRating ? (_jsxs(_Fragment, { children: [rating.toFixed(1).replace('.', ','), _jsxs("span", { className: "font-normal text-muted-foreground", children: ["(", reviewCount, ")"] })] })) : (_jsx("span", { className: "font-normal text-muted-foreground", children: "Novo" }))] }));
}
