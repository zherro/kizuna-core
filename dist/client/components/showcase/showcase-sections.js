...
export function PreferenciasHeader() {
  return (
    ...
    },
    {
        ...
        groupId: 'ui-better-soft',
        label: 'Page Header',
        description: 'Cabecalho de pagina de listagem/gestao: eyebrow + titulo + descricao a esquerda, acoes (voltar, nova acao...) a direita. Empilha no mobile.',
...
export function LunchBreakField() {
  ...
  return (
    ...
    },
    {
        ...
        description: 'Bloco com icone, titulo, descricao e conteudo. Agrupa controles de uma pagina de configuracoes.',
...
export function SchedulePreferencePicker() {
  ...
  return (
    ...
    },
    {
        ...
        groupId: 'ui-better-soft',
        label: 'Modal Panel',
        description: 'Painel lateral que desliza da direita (mesmo formato do Sheet usado em formularios de criar/editar), com icone, titulo, descricao, conteudo e rodape de acoes.',
        usageCode: `import { useState } from 'react';
