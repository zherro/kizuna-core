...
export function MosaicGridExactPreview() {
  return <MosaicGrid items={mosaicItems} />;
    ...
    },
    {
        ...
        groupId: 'ui-better-soft',
        label: 'Page Header',
        description: 'Cabecalho de pagina de listagem/gestao: link de voltar opcional (seta + texto) + eyebrow + titulo + descricao a esquerda, acoes (nova acao...) a direita. Empilha no mobile. Tamanho/peso do titulo vem do tema ativo (NEXT_PUBLIC_UI_STYLE), igual PageHeading.',
...
export function ServicosHeader() {
  return (
    ...
    },
    {
        ...
        groupId: 'ui-better-soft',
        label: 'BS Button',
        description: 'Botao com estilos fixos (sem className) e icone opcional. Variantes: default e outline.',
...
export function ChannelPicker() {
  ...
  return <ChannelChip label="E-mail" checked={email} onChange={setEmail} />;
    ...
    },
    {
        ...
        groupId: 'ui-better-soft',
        label: 'Schedule Row',
        description: 'Linha com switch, rotulo e intervalo de horario (inicio/fim). Usado para dias da semana e pausas.',
        usageCode: `import { useState } from 'react';
...
export function LunchBreakField() {
  ...
  return (
    ...
    },
    {
        ...
        description: 'Card do kit: com cabecalho (icone + titulo + descricao) no variant="default", ou sem cabecalho para item de lista (variant="compact") ou wrapper maior (variant="flat"). Raio/sombra vem do tema ativo (NEXT_PUBLIC_UI_STYLE).',
...
export function SchedulePreferencePicker() {
  ...
  return (
    ...
    },
    {
        ...
        groupId: 'ui-better-soft',
        label: 'Modal Panel',
        description: 'anchor="side" (padrao) desliza da direita, mesmo formato do Sheet. anchor="bottom-sheet" ancora embaixo, sem drag handle — para telas mobile. title e opcional: sem ele, o painel nao renderiza cabecalho e quem chama monta o proprio topo em children.',
        usageCode: `import { useState } from 'react';
...
export function AbsenceRow() {
  return (
    ...
    },
    {
        ...
        description: 'Casca generica de cartao de resultado de listagem: capa com badges opcionais, titulo, subtitulo, linha opcional (avatar+nome, rating...) e rodape (preco/CTA). Quem chama monta os conteudos dos slots.',
...
export function ServiceCardExample() {
  return (
    ...
    },
    {
        ...
        description: 'Grade de cartoes selecionaveis (icone + titulo + descricao), para um passo de escolha de grupo/categoria. accent troca entre o tom brand e primary; layout troca entre icone em cima (vertical) ou ao lado (horizontal).',
...
export function GroupPicker() {
  ...
  return (
    ...
    },
    {
        ...
        description: 'Lista de chips (pills) selecionaveis em multipla escolha, para marcar variacoes/tags num passo de wizard.',
        usageCode: `import { useState } from 'react';
...
export function NoAbsences() {
  return (
    ...
    },
    {
        ...
        groupId: 'ui-better-soft',
        label: 'Form Field',
        description: 'Campo normalizado ligado ao Formik: input, textarea ou switch com label e erro. Substitui os wrapper-field/checkbox/textarea (deprecated).',
...
export function CustomDayOffForm() {
  ...
  return (
    ...
    },
    {
        ...
        groupId: 'ui-better-soft',
        label: 'Number Field',
        description: 'Campo numerico com stepper (-/input/+), sufixo e dica opcionais. Para ajustes de preferencias como antecedencia, buffer e raio de atendimento.',
        usageCode: `import { useState } from 'react';
...
export function ServiceRadiusField() {
  ...
  return (
    ...
    },
    {
        ...
        description: 'Balao de mensagem + mascote SVG animavel, usado no topo de paginas do painel para dar contexto. Aceita uma cena registrada (sceneKey) ou uma cena inline (scene).',
...
export function CustomSceneHeader() {
  return (
    ...
    },
    {
        ...
        description: 'Alternancia cards/lista com persistencia em localStorage, estado vazio e acoes no cabecalho. Generico: quem chama define renderCard/renderRow.',
...
export function ItemsSection({ items }: { items: Item[] }) {
  return (
    ...
    },
    {
        ...
        groupId: 'ui-better-soft',
        label: 'Inline Alert',
        description: 'Banner inline pequeno para feedback de erro/sucesso acima de um formulario ou passo de wizard.',
...
export function StepErrors({ loadError }: { loadError: string | null }) {
  return loadError ? <InlineAlert type="error" text={loadError} /> : null;
    ...
    },
    {
        ...
        groupId: 'ui-better-soft',
        label: 'RPC Tester',
        description: 'Ferramenta de debug: executa uma funcao RPC do PostgREST (schema + nome + parametros JSON) contra um endpoint POST e mostra status/payload. Sem regra de negocio, generico por endpoint.',
...
export function FuncoesPage() {
  return <RpcTester endpoint="/api/postgrest/rpc" backHref="/painel" />;
    ...
    },
    {
        ...
        groupId: 'ui-better-soft',
        label: 'PWA Register',
        description: 'Componente sem UI: registra o service worker do app, com uma limpeza de cache/registro rodando uma unica vez (guardada por migrationKey no localStorage). swUrl e migrationKey sao especificos de cada projeto.',
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    ...
    },
    {
        ...
        description: 'Seletor de localizacao (estado -> cidade) via API do IBGE, com deteccao automatica opcional. LocationTrigger e o botao que parece um select; LocationModal e o dialogo de escolha.',
        usageCode: `import { useState } from 'react';
...
export function LocationPicker() {
  ...
  return (
    ...
    },
    {
        ...
        description: 'Card generico pra editar UM registro de auth.system_config (plugin system_config) — o projeto so declara os campos (toggle/select/textarea), o componente cuida de renderizar e salvar via /api/resources/system_config/<key>.',
...
export function DocumentFieldConfig() {
  return (
    ...
    },
    {
        ...
        groupId: 'ui-better-soft',
        label: 'Form Builder',
        description: 'Engine de formularios: FormBuilder (editor visual) + FormRenderer + FormResultViewer, com key obrigatoria, visibilidade condicional e opcoes vindas de um recurso.',
        usageCode: `import { useState } from 'react';
import {
  FormBuilder,
  FormRenderer,
...
export function FormEngineExample() {
  ...
  return (
    ...
    },
    {
        ...
        groupId: 'ui-better-soft',
        label: 'Forms manager',
        description: 'Formularios reutilizaveis: FormBuilder -> FormRenderer + validate() -> FormResultViewer. Base do passo dinamico do wizard de servicos e da tela /painel/administracao/formularios.',
...
// no persist() do wizard: await ref.current?.persist();`,
    },
    {
        ...
        groupId: 'ui-better-soft',
        label: 'Pages Admin',
        description: 'Gestao master/detail das paginas institucionais do plugin pages (Markdown, slug automatico, publicar/rascunho, exclusao suave). Salva em /api/resources/pages.',
...
export function TimeChip() {
  return <ColorChip color="var(--color-info)">14:00</ColorChip>;
    ...
    },
    {
        ...
        groupId: 'ui-better-soft',
        label: 'Fab',
        description: 'Botão circular único, fixo no rodapé — a ação primária de uma tela mobile. Sem pílula, sem ação secundária.',
...
export function NovoCompromissoFab() {
  return <Fab icon={Plus} onClick={() => {}} ariaLabel="Novo compromisso" />;
    ...
    },
    {
        ...
        groupId: 'ui-better-soft',
        label: 'Page Heading',
        description: 'Heading simples de topo de tela (saudação, sem ações): eyebrow, título grande, descrição opcional. Tamanho do título vem do tema ativo (NEXT_PUBLIC_UI_STYLE).',
...
export function AgendaGreeting() {
  return (
    ...
    },
    {
        ...
        description: 'Substituto do <select> nativo no mobile — o sistema operacional delega a UI da roda/lista fullscreen, fora do alcance de qualquer CSS.',
        usageCode: `import { useState } from 'react';
...
export function MonthPicker() {
  ...
  return (
    ...
    },
    {
        ...
        groupId: 'tools',
        label: 'Shadow Lab',
        description: 'Ferramenta de dev para moldar um box-shadow na hora (deslocamento, desfoque, espalhamento, opacidade), com preview em branco-sobre-branco e cor-do-tema-sobre-fundo — os dois casos onde uma sombra fraca "some".',
...
export const DEFAULT_SHOWCASE_SECTION = 'cards';
export function isShowcaseSection(value) {
    return SHOWCASE_SECTIONS.some((section) => section.id === value);
}
export function normalizeShowcaseSection(value) {
    if (isShowcaseSection(value))
        return value;
    if (value === 'ui-better-soft')
        return 'experience-pill';
    if (value === 'stepper')
        return 'bottom-progress-bar';
    return null;
}
export function getShowcaseSection(id) {
    return SHOWCASE_SECTIONS.find((section) => section.id === id) ?? SHOWCASE_SECTIONS[0];
}
//# sourceMappingURL=showcase-sections.js.map