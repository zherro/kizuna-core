export type ShowcaseSectionId = 'cards' | 'buttons' | 'forms' | 'tables' | 'alerts' | 'progress' | 'experience-pill' | 'wizard-layout-toggle' | 'bottom-progress-bar' | 'mosaic-grid' | 'page-header' | 'bs-button' | 'toggle-row' | 'channel-chip' | 'schedule-row' | 'settings-section' | 'choice-card' | 'modal-panel' | 'confirm-dialog' | 'filter-stat-card' | 'entity-list-card' | 'media-result-card' | 'icon-choice-grid' | 'chip-toggle-list' | 'empty-state-card' | 'form-field' | 'number-field' | 'section-illustration' | 'entity-grid-list' | 'inline-alert' | 'rpc-tester' | 'pwa-register' | 'location-modal' | 'system-config-section' | 'form-builder' | 'forms-manager' | 'pages-admin' | 'color-chip' | 'fab' | 'page-heading' | 'select-popover' | 'shadow-lab';
