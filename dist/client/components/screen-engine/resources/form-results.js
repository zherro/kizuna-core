...
export const FORM_RESULTS_RESOURCE = {
    schema: 'public',
    table: 'form_results',
    select: 'id,uid,form_id,form_key,reference_id,domain,version,schema_snapshot,answers,submitted_by,created_at,updated_at',
    primaryKey: 'id',
...
export const resourceFormResults = {
    form_results: FORM_RESULTS_RESOURCE,
};
//# sourceMappingURL=form-results.js.map