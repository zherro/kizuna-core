 ...
 */
export const resourcePedidos = {
    pedido: {
        schema: 'public',
        table: 'pedido',
        select: 'id,uid,cliente_id,prestador_id,conversation_id,origem,status,confirmado_em,created_at,updated_at,conversation:conversation_id(uid)',
        primaryKey: 'id',
        ...
        mapOutput: (record) => ({
            ...
            conversationUid: record.conversation?.uid ?? null,
    ...
    pedido_servico: {
        ...
        select: 'id,uid,pedido_id,service_id,status,agenda_event_id,created_at,updated_at,service:service_id(id,title,extras)',
        primaryKey: 'id',
        defaultOrder: 'created_at',
        searchableColumns: [],
        mapInput: () => ({}),
