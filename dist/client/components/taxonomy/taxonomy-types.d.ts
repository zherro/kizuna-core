...
export type TaxonomyEditTarget = {
    level: 'group';
    item: TaxonomyGroup | null;
    defaultSortOrder?: number;
} | {
    level: 'category';
    item: TaxonomyCategory | null;
} | {
    level: 'subcategory';
...
export declare const TAXONOMY_RESOURCE_BY_LEVEL: Record<TaxonomyLevel, string>;
export declare const TAXONOMY_LEVEL_LABEL: Record<TaxonomyLevel, string>;
