...
import { checkKizunaEnv } from '../lib/env-guard';
function getSecret() {
...
function setupRequiredHtml(missing) {
    const rows = missing
        .map((m) => `<li style="border:1px solid #26262c;border-radius:10px;padding:12px 14px;background:#141417">
