...
const DEFAULT_SITEMAP_CACHE_SECONDS = 86_400; // 24h — um sitemap não precisa de TTL curto

/** Lê `SEO_SITEMAP_CACHE` da env; ausente ou inválida cai no default de 24h. */
export function getSeoSitemapCacheSeconds(): number {
...
export function getSeoSitemapPageSize(): number {
