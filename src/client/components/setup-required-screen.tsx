    ...
    >
      <main style={{ maxWidth: 560, width: '100%' }}>
        ...
        <p style={{ color: '#a8a8b2', lineHeight: 1.6, marginTop: 0 }}>
          ...
          abaixo no arquivo{' '}
          <code style={{ background: '#1c1c20', padding: '2px 6px', borderRadius: 4 }}>.env</code>{' '}
          (copie de{' '}
          <code style={{ background: '#1c1c20', padding: '2px 6px', borderRadius: 4 }}>
            .env.example
          </code>
          ) e recarregue.
        </p>
        ...
        <ul style={{ listStyle: 'none', padding: 0, margin: '20px 0 0', display: 'grid', gap: 12 }}>
          {missing.map((m) => (
            ...
            >
              ...
              <p style={{ margin: '6px 0 0', fontSize: 13, color: '#9a9aa4', lineHeight: 1.5 }}>
                {m.hint}
              </p>
            </li>
          ))}
