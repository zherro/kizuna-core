...
type RegisterFormProps = {
  ...
  /** Endpoint that accepts `{ name, email, password, acceptTerms }`. Mesmo default de hoje. */
  registerEndpoint?: string;
  /** Link to the login screen. Pass `null` to hide the "already have an account" line. Mesmo default de hoje. */
